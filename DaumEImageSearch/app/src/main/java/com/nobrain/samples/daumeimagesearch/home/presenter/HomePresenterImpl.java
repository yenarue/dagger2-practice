...
public class HomePresenterImpl implements HomePresenter {
    ...
    void loadSearchResult(String text) {
        Log.d("myTest", "loadSearchResult=" + text);
        searchApi.searchText(text, pageCount)
                ...
                .subscribe(item -> {
                            Log.d("searchApi - SearchText", "onNext : " + item);
                            imageAdapterDataModel.add(item);
                        },
                        Throwable::printStackTrace,
                        () -> {
                            Log.d("searchApi - SearchText", "onComplete");
                            view.refresh();
                        });
}
    ...
    public void inputSearchText(String searchText) {
        Log.d("myTest", "inputSearchText=" + searchText);
